              ...
              <tr key={movie.id} className="border-t">
                {editingMovie && editingMovie.id === movie.id ? (
                  <>
                    ...
                    <td className="p-4">
                      <input
                        ...
                        onChange={(e) => setEditingMovie({...editingMovie, disponible: e.target.checked})}
                      />
                    </td>
                    <td className="p-4">
                  ...
                  <>
                    ...
                    <td className="p-4">{Array.isArray(movie.genre) ? movie.genre.join(', ') : movie.genre}</td>
                    ...
                    <td className="p-4 space-x-2">
                      ...
                      <button onClick={() => handleEdit(movie)} className="text-blue-600 hover:text-blue-800">
                        ✏️
                      </button>
                      <button onClick={() => handleToggleAvailability(movie.id)} className="text-yellow-600 hover:text-yellow-800">
                        ⭐
                      </button>
                    </td>
                  </>
